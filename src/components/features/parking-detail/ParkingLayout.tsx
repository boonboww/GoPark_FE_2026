...
import { ParkingLayoutSkeleton } from "@/components/skeletons/ParkingLayoutSkeleton";
...
export function ParkingLayout() {
  ...
  const { dataLot, loadingLot, selectedSpot, setSelectedSpot } = context;
  ...
  return (
    <AnimatePresence mode="wait">
      {loadingLot ? (
        ...
        >
          <motion.h2 variants={itemVariants} className="text-xl font-bold text-gray-900 dark:text-white mb-6">
            Sơ đồ bãi đỗ ô tô : {dataLot.name}
          </motion.h2>
          ...
          <motion.div variants={itemVariants} className="bg-gray-50 dark:bg-gray-900/50 p-6 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 overflow-x-auto">
