          ...
          <AnimatePresence mode="wait">
            {success ? (
              ...
              >
                ...
                <p className="text-xl font-bold text-slate-800">Điểm trí hoàn tất!</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-left">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1.5">
                      <Label htmlFor="password" className="text-slate-600 font-semibold text-xs">
                        Mật khẩu mới
                      </Label>
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="confirmPassword" className="text-slate-600 font-semibold text-xs">
                        Xác nhận mật khẩu
                      </Label>
                      <div className="relative group">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-500 transition-colors">
